...
package com.online.nutrition.dietdiary.database;
...
/**
 * This is taken this from Android's SQLiteOpenHelper.
 * 
 */
 ...
 * </p>
 */
public abstract class DDSQLiteOpenHelper {
    private static final String t = DDSQLiteOpenHelper.class.getSimpleName();
     ...
     */
    public DDSQLiteOpenHelper(String path, String name, CursorFactory factory, int version) {
        if (version < 1)
